  ...
  return (
    <section className="py-24 overflow-hidden">
      <div className="container">
        ...
        <h2 className="text-6xl font-medium mt-6 leading-1.9">
       ...
       <div>
         <div className="h-100 lg:h-200 overflow-hidden lg:mt-0 mt-8 mask-[linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)] grid md:grid-cols-2 gap-4">
